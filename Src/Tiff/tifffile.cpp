...
TiffIfdEntry::TiffIfdEntry() : d(new TiffIfdEntryPrivate) { }

TiffIfdEntry::TiffIfdEntry(const TiffIfdEntry &other) : d(other.d) { }
...
TiffIfd::TiffIfd() : d(new TiffIfdPrivate) { }

TiffIfd::TiffIfd(const TiffIfd &other) : d(other.d) { }
...
TiffIfdEntry TiffIfd::ifdEntry(quint16 tag) const
{
    return d->ifdEntry(tag);
}
