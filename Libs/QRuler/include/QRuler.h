 ...
 *
 * This is a standalone version extracted from Krita's KoRuler.
 */
class QRULER_EXPORT QRuler : public QWidget
{
    Q_OBJECT
public:
    /**
     ...
     */
    QRuler(QWidget *parent, Qt::Orientation orientation, const ViewConverter *viewConverter);
    ~QRuler() override;
...
Q_SIGNALS:
    ...
    /// emitted when the user is about to change a tab or hotspot
    void aboutToChange();
